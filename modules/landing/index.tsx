...
import { instructions, accordionData, coreAreasOfService } from "../../constants";
    ...
    <main className="h-100 w-100 bg-gray-50">
        ...
        <div
          className={`flex flex-col justify-center items-center ${
            isTabletOrMobile ? "mt-[50px]" : "mt-[0px]"
          }`}
        >
          <div className="flex flex-col justify-center items-center leading-tight">
          ...
          <div className={ isDesktopOrLaptop ? "w-8/12" : "w-10/12"}>
            <p className="text-zinc-500 text-[16px] font-sans font-normal text-center">
              Our wealth management as a service platform provides personalized
              investment strategies and comprehensive management, tailored to
